...
func TestPodStore_decorateNode_hyperPodNode_Schedulable(t *testing.T) {
	...
	assert.True(t, metric.HasField("hyper_pod_node_health_status_unschedulable_pending_replacement"))
	assert.True(t, metric.HasField("hyper_pod_node_health_status_schedulable_preferred"))
	assert.True(t, metric.HasField("hyper_pod_node_health_status_unschedulable_pending_reboot"))
	assert.True(t, metric.HasField("hyper_pod_node_health_status_unschedulable"))
	...
	assert.Equal(t, uint64(0), metric.GetField("hyper_pod_node_health_status_unschedulable_pending_replacement").(uint64))
	assert.Equal(t, uint64(0), metric.GetField("hyper_pod_node_health_status_schedulable_preferred").(uint64))
	assert.Equal(t, uint64(0), metric.GetField("hyper_pod_node_health_status_unschedulable_pending_reboot").(uint64))
	assert.Equal(t, 0, metric.GetField("hyper_pod_node_health_status_unschedulable").(int))
	assert.Equal(t, uint64(0), metric.GetField("hyper_pod_node_health_status_status_condition_unknown").(uint64))
}

func TestPodStore_decorateNode_hyperPodNode_Unschedulable(t *testing.T) {
	podStore := getPodStore()
	podStore.nodeInfo.nodeName = "hyperpod-testNode3"
	defer require.NoError(t, podStore.Shutdown())
	...
	assert.Equal(t, uint64(0), metric.GetField("hyper_pod_node_health_status_schedulable").(uint64))
	assert.Equal(t, uint64(1), metric.GetField("hyper_pod_node_health_status_unschedulable_pending_replacement").(uint64))
	assert.Equal(t, uint64(0), metric.GetField("hyper_pod_node_health_status_schedulable_preferred").(uint64))
	assert.Equal(t, uint64(0), metric.GetField("hyper_pod_node_health_status_unschedulable_pending_reboot").(uint64))
	assert.Equal(t, 1, metric.GetField("hyper_pod_node_health_status_unschedulable").(int))
	assert.Equal(t, uint64(0), metric.GetField("hyper_pod_node_health_status_status_condition_unknown").(uint64))
}
